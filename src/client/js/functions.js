...
export const postData = async ( url = '', data = {})=>{
    ...
    try {
      ...
      return newData;
        ...
        alert("Unable to look up Geo information at this time");
    }
}

//similar post to get weather info
...
//same as above get pic post call
...
//get call get show gathered data in the UI
