function handleSubmit(event, url) {
    ...
    Client.postData(url, {city:document.getElementById('city').value}).then(function(data){
        Client.postWeather('/getWeather',{lat:data.lat, lng:data.lng, start_date: document.getElementById('start-date').value, end_date: document.getElementById('end-date').value});
    });
